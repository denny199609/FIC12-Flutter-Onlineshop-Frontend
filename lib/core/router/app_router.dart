...
import 'package:flutter_onlineshop_apps/presentation/address/models/address_model.dart';
import 'package:flutter_onlineshop_apps/presentation/address/pages/add_address_page.dart';
import 'package:flutter_onlineshop_apps/presentation/address/pages/address_page.dart';
import 'package:flutter_onlineshop_apps/presentation/address/pages/edit_address_page.dart';
import 'package:flutter_onlineshop_apps/presentation/auth/pages/login_page.dart';
import 'package:flutter_onlineshop_apps/presentation/auth/pages/register_page.dart';
import 'package:flutter_onlineshop_apps/presentation/home/pages/dashboard_page.dart';
import 'package:flutter_onlineshop_apps/presentation/home/pages/product_detail_page.dart';
import 'package:flutter_onlineshop_apps/presentation/home/pages/product_page.dart';
import 'package:flutter_onlineshop_apps/presentation/home/pages/product_search_page.dart';
import 'package:flutter_onlineshop_apps/presentation/orders/pages/cart_page.dart';
      ...
      GoRoute(
          ...
          routes: [
            GoRoute(
                ...
                path: RouteConstants.productsPath,
                builder: (context, state) {
            ...
            GoRoute(
                name: RouteConstants.productSearch,
                path: RouteConstants.productSearchPath,
                builder: (context, state) {
                      ...
                      GoRoute(
                        ...
                        routes: [
                          GoRoute(
                              ...
                              builder: (context, state) {
                                final orderIDx = state.extra as int;
                          ...
                          GoRoute(
                            ...
                            builder: (context, state) {
                              // id as extra to trackingorderpage
                              final orderIDx = state.extra as int;
                            ...
                            routes: [
                              GoRoute(
                                  ...
                                  builder: (context, state) {
                                    final shippingResix = state.extra as String;
                                    return ShippingDetailPage(
                                      shippingResi: shippingResix,
                                    );
                                  }),
                            ],
                          ),
