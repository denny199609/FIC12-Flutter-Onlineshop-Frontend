...
class RouteConstants {
  ...
  /// route for page [ProductPage]
  static const String products = 'product';
  static const String productsPath = 'product';

  /// route for page [ProductSearchPage]
  static const String productSearch = 'product_search';
  static const String productSearchPath = 'product_search';
