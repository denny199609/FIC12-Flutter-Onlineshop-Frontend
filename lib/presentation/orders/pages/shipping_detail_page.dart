...
class _ShippingDetailPageState extends State<ShippingDetailPage> {
  ...
  void initState() {
    context
        .read<TrackingBloc>()
        .add(TrackingEvent.getTracking(widget.shippingResi.toString(), 'sicepat'));
    super.initState();
  }
                  ...
                  loaded: (trackResi) {
                    return Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              InkWell(
                                onTap: () =>
                                    copyToClipboard('${widget.shippingResi}'),
                                child: const Text(
                                  'SALIN',
                                  style: TextStyle(
                                    fontSize: 16,
                        ...
                        Padding(
                          padding: const EdgeInsets.all(16.0),
                          child: TrackignVertical(trackRecords: trackResi.rajaongkir?.result!.manifest ?? []),
                        ),
                      ],
                    );
                  },
